...
public class SocialEngineOperation {
	...
	public eu.trentorise.smartcampus.social.model.Concept getTestConcept()
			throws WebApiException {
		Concept c = client.readConceptByGlobalId(testConceptId, knownledgeBase);
		eu.trentorise.smartcampus.social.model.Concept localConcept = new eu.trentorise.smartcampus.social.model.Concept();
		localConcept.setId(c.getId().toString());
