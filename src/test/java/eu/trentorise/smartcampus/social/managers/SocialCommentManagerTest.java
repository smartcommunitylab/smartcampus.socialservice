...
public class SocialCommentManagerTest {
	...
	public void readCommentsByEntityId(){
		List<Comment> commentsReaded = manager.readCommentsByEntity(ENTITYID2, null);
	...
	public void readCommentsByEntityIdNotExist(){
		List<Comment> commentsReaded = manager.readCommentsByEntity(ENTITYID_NE, null);
		Assert.assertTrue(commentsReaded.isEmpty());
	}		
	
	@Test
	public void readCommentsByEntityIdAndTextAndAuthor(){
		Comment commentReaded = manager.readCommentsByAutorAndTextAndEntity(AUTHOR1, COMMENTTEXT1, ENTITYID1);
